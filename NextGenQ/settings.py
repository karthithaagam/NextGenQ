"""
Django settings for NextGenQ project.
...
SECRET_KEY = 'django-insecure-hp&p3!nw$ueh%25=tkxu9-p^b4^l4^m7piu7$8386hvixj8i-)'
...
WSGI_APPLICATION = 'NextGenQ.wsgi.application'
